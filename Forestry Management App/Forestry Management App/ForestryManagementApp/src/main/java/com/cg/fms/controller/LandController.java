...
public class LandController {
	...
	public String addLand(@PathVariable("landId") String landId, @PathVariable("surveyNumber") String surveyNumber, @PathVariable("ownerName") String ownerName, @PathVariable("landArea") String landArea) {
